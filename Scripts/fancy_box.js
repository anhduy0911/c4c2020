		...
		n.extend(p.prototype, {
					...
					n.fancybox.getInstance() ||
						...
						/iPad|iPhone|iPod/.test(navigator.userAgent) && !t.MSStream
							...
							: !n.fancybox.isMobile &&
							  ...
							  (d === o &&
									((i = n('<div style="width:50px;height:50px;overflow:scroll;" />').appendTo(
										'body'
									)),
					...
					n.isPlainObject(i)
						...
						!s &&
							...
							(c.match(
								...
								? ((s = 'video'),
								  u.opts.videoFormat ||
										(u.opts.videoFormat = 'video/' + ('ogv' === r[1] ? 'ogg' : r[1])))
								: '#' === c.charAt(0) && (s = 'inline')),
						...
						'ajax' === s &&
							((l = c.split(/\s+/, 2)),
							l.length > 1 && ((u.src = l.shift()), (u.opts.filter = l.shift()))),
				...
				if (!(p.isDragging || p.isClosing || (p.isAnimating && p.firstRun))) {
					...
					if (((a = p.firstRun = null === p.firstRun), !(h < 2 && !a && p.isDragging))) {
						if (
							...
							(r.isMoved =
								(0 !== u.left || 0 !== u.top) && !r.$slide.hasClass('fancybox-animated')),
							(r.forcedDuration = o),
							n.isNumeric(e)
								? (r.forcedDuration = e)
			...
			isScaledDown: function () {
				var t = this,
					...
					i = !1;
				return (
					o && ((i = n.fancybox.getTranslate(o)), (i = i.width < e.width || i.height < e.height)), i
				);
			},
			canPan: function () {
				var t = this,
			...
			focus: function () {
				...
				this.isClosing ||
					(e &&
						...
						t.length ||
							(t = e.$slide.find('button,:input,[tabindex],a').filter(':enabled:visible:first'))),
				...
				return (
					...
					l.trigger('beforeClose', t) === !1
						...
						: (l.removeEvents(),
						  ...
						  i &&
								l.$refs.container.removeClass('fancybox-is-open').addClass('fancybox-is-closing'),
						  l.hideLoading(p),
						  l.hideControls(),
						  l.updateCursor(),
						  'zoom' !== o ||
				...
				animate: function (t, e, i, a, s) {
					n.isFunction(i) && ((a = i), (i = null)),
						...
						t.on(d, function (i) {
							(!i ||
								!i.originalEvent ||
								(t.is(i.originalEvent.target) && 'z-index' != i.originalEvent.propertyName)) &&
								(n.fancybox.stop(t),
								n.isPlainObject(e)
									? (e.scaleX !== o &&
											e.scaleY !== o &&
				...
				h
					? ((a.src = p),
					  ...
					  'iframe' === h &&
							...
							(a.contentProvider = f),
							(a.opts.slideClass +=
								' fancybox-slide--' + ('gmap_place' == f || 'gmap_search' == f ? 'map' : 'video'))))
						...
						n.each(s.instance.slides, function (t, e) {
							n.fancybox.stop(e.$slide),
								...
								e.pos === s.instance.current.pos &&
									(s.sliderStartPos.left = n.fancybox.getTranslate(e.$slide).left);
						}),
		...
		e.extend(n.prototype, {
			...
			create: function () {
				var t,
					...
					a = o.opts.parentEl;
				(o.$grid = e(
					'<div class="fancybox-thumbs fancybox-thumbs-' + o.opts.axis + '"></div>'
							...
							(t = this.naturalWidth || this.width),
								...
								e(this)
									.css({
										...
										height: Math.floor(n),
										'margin-top':
											n > r ? Math.floor(0.3 * r - 0.3 * n) : Math.floor(0.5 * r - 0.5 * n),
			...
			e(t).on('click', '[data-fancybox-share]', function () {
				...
				i &&
					...
					(o = i.current.opts.share.tpl
						.replace(
							/\{\{media\}\}/g,
							'image' === i.current.type ? encodeURIComponent(i.current.src) : ''
						)
